        ...
        <div className={s.taskCard}>
          ...
          {isCompleted ? (
            <>
              ...
              <div className={s.encouragement}>{lesson.encouragement}</div>
            </>
          ) : (
            <>
              <Textarea
              ...
              {isSubmitted && <div className={s.encouragement}>{lesson.encouragement}</div>}
            </>
          )}
